<div>
  <h1>Yet Another Vue 3 Boilerplate Template v0.6.0</h1>
  <div>
...
| [yup](https://github.com/jquense/yup)                                           | ![yup](https://img.shields.io/badge/%5E1.7.1-blue.svg)                   | Yup, I kinda understand what this is for. Instead of writing regex manually for form validation, you can use yup's methods and chain them. Yup, it's kinda interesting.                                                                                                                                                      |
| [Tanstack Query](https://tanstack.com/query/latest/docs/framework/vue/overview) | ![@tanstack/vue-query](https://img.shields.io/badge/%5E5.101.4-blue)     | I'm pretty late for this Tanstack party. It's so incredibly useful, especially for trying to handle data tables. You can manage what to cache, when to fetch, and other neat features. The only downside is that it needs quite a lot of configs at first. The documentation is good and easy to understand, what a delight! |
